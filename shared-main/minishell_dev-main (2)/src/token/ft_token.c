...
/*   Updated: 2024/10/10 01:06:24 by hrazafia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_set_type(t_type *type, char *lexeme, t_flag *flag)
{
	if (ft_str_compare(lexeme, LEXEME_HEREDOC))
		ft_set_operator_type(type, TOKEN_HEREDOC, flag);
	else if (ft_str_compare(lexeme, LEXEME_INPUT_REDIR))
		ft_set_operator_type(type, TOKEN_INPUT_REDIR, flag);
	else if (ft_str_compare(lexeme, LEXEME_APPEND))
		ft_set_operator_type(type, TOKEN_APPEND, flag);
	else if (ft_str_compare(lexeme, LEXEME_OUTPUT_REDIR))
		ft_set_operator_type(type, TOKEN_OUTPUT_REDIR, flag);
	else if (ft_str_compare(lexeme, LEXEME_PIPE))
