...
/*   Updated: 2024/10/10 01:04:16 by hrazafia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_add_ptr(t_list **ptr_list, void *ptr);
...
static void	ft_add_varvalue(t_data *data, t_list **str, char *name, size_t *i)
{
	...
	{
		var_value = ft_itoa(data->exit.value);
		ft_add_ptr(&data->exit.conv_addr, var_value);
	}
	else
